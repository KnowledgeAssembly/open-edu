        ...
        >
          ...
          <TabsContent value="file" className="space-y-4 pt-4">
            <input
              ...
              className="text-caption text-on-surface file:bg-surface-container file:text-on-surface file:hover:bg-surface-container-highest w-full file:mr-3 file:cursor-pointer file:rounded-md file:border-0 file:px-3 file:py-1.5 file:transition-colors"
            />
            <Button
