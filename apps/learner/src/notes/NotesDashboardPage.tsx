...
export function NotesDashboardPage({ onNavigate }: NotesDashboardPageProps): JSX.Element {
  ...
  if (loading) {
    return (
      <div
        ...
        className="p-xl mx-auto flex max-w-5xl items-center justify-center"
      >
  ...
  return (
    <div data-testid="notes-page" className="p-xl mx-auto flex max-w-5xl flex-col">
      <PageHeader
      ...
      <div className="flex flex-col gap-6">
        ...
        {notes.length === 0 ? (
          ...
          <>
            <section>
              <h2 className="text-h4 mb-3 font-semibold">{t('notes.dashboard.section.recent')}</h2>
              {recent.length > 0 ? (
                <div
