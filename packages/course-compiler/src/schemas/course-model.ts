...
export const ShortAnswerQuestionSchema = z
  .object({
    id: z.string(),
...
export const ReadingActivitySchema = z
  .object({
    id: z.string(),
...
export const ExerciseActivitySchema = z
  .object({
    id: z.string(),
...
export const DiscussionActivitySchema = z
  .object({
    id: z.string(),
...
export const ReflectionActivitySchema = z
  .object({
    id: z.string(),
...
export const VideoActivitySchema = z
  .object({
    id: z.string(),
