...
export const zen: ThemeDefinition = {
  ...
  typography: {
    productive: {
      ...
      heading3: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '18px', fontWeight: '400', lineHeight: '1.4' },
      heading4: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '16px', fontWeight: '400', lineHeight: '1.4' },
      heading5: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '14px', fontWeight: '500', lineHeight: '1.5' },
      heading6: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '12px', fontWeight: '500', lineHeight: '1.5' },
      body: {
        fontFamily: 'Inter, system-ui, -apple-system, sans-serif',
        fontSize: '14px',
        fontWeight: '420',
    ...
    expressive: {
      ...
      heading3: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '18px', fontWeight: '400', lineHeight: '1.4' },
      heading4: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '16px', fontWeight: '500', lineHeight: '1.5' },
      heading5: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '14px', fontWeight: '500', lineHeight: '1.6' },
      heading6: { fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '12px', fontWeight: '500', lineHeight: '1.6' },
      body: {
        fontFamily: 'Inter, system-ui, -apple-system, sans-serif',
        fontSize: '17px',
        fontWeight: '420',
