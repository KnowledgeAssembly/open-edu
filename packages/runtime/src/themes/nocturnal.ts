...
export const nocturnal: ThemeDefinition = {
  ...
  typography: {
    productive: {
      ...
      heading4: { fontFamily: 'Inter', fontSize: '18px', fontWeight: '500', lineHeight: '26px' },
      heading5: { fontFamily: 'Inter', fontSize: '16px', fontWeight: '500', lineHeight: '24px' },
      heading6: { fontFamily: 'Inter', fontSize: '14px', fontWeight: '500', lineHeight: '20px' },
      body: {
        fontFamily: 'Inter',
        fontSize: '14px',
        fontWeight: '400',
    ...
    expressive: {
      ...
      heading3: { fontFamily: 'Inter', fontSize: '18px', fontWeight: '500', lineHeight: '26px' },
      heading4: { fontFamily: 'Inter', fontSize: '16px', fontWeight: '500', lineHeight: '24px' },
      heading5: { fontFamily: 'Inter', fontSize: '14px', fontWeight: '400', lineHeight: '22px' },
      heading6: { fontFamily: 'Inter', fontSize: '12px', fontWeight: '400', lineHeight: '20px' },
      body: {
        fontFamily: 'Inter',
        fontSize: '16px',
        fontWeight: '400',
