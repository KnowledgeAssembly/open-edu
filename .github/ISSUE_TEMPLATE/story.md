...
- **Allowed directories**: (e.g., `apps/web/pages/`, `packages/ui/src/`)
...
- **Design**: Relevant design guidelines or conventions.
- **API**: Validation, auth, or contract requirements.
- **Database**: Schema conventions, key constraints.
- **Accessibility**: Touch targets, ARIA, or other requirements.

---

## Deliverables
Exactly what outputs are expected:
- [ ] Implementation (code / components / API endpoints)
...
- **Commands**: test and lint commands
