...
| `@open-edu/widgets`         | Widget SDK — registry, **21 built-in widgets** (14 stable + 6 experimental + 1 deprecated), **enriched metadata** (AI, capabilities, accessibility, analytics, reward), **metadata validation**, **catalog generation**, remote widget loader, NPM scaffold template                                                                                                            | Done   |
