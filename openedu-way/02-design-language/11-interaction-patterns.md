...
Interaction patterns define how common learning experiences are
structured across OpenEdu.

While components are individual building blocks, patterns combine them
into familiar, repeatable experiences.
...
Common activities should follow common patterns.
...
Start with what the learner needs now.
...
Every meaningful action should receive clear, calm feedback.
...
Patterns describe user experience rather than implementation details.
...
Patterns become invisible through repetition.

When learners instinctively know what to do next, the interface has
