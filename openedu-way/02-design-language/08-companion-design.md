...
Pipili should be constructed from the same geometric language used
throughout OpenEdu.

Its form should communicate assembly rather than complexity.
...
Pipili communicates primarily through posture, orientation, and gentle
motion.

Facial expressions should remain subtle.

Emotion should be suggested rather than exaggerated.
...
Pipili should adapt naturally across different contexts.
...
Pipili should appear intentionally.
...
The Companion Design defines visual principles rather than
...
Pipili is remembered not because it appears often, but because it
appears when it matters.

Its greatest strength is quiet companionship.

Like learning itself, Pipili grows through meaningful connections, one
piece at a time.
