...
Geometry is the visual foundation of OpenEdu.

Just as Open Modules are the conceptual building blocks of learning,
geometry provides the building blocks of the visual language.

Every icon, illustration, pattern, component, and animation should
emerge from a shared geometric system.
...
OpenEdu is built on the idea that **knowledge is assembled**.

The visual language should express the same idea.

Instead of relying on decorative shapes, OpenEdu uses a small set of
simple geometric forms that combine to create richer structures.
...
OpenEdu is built from a single visual primitive.
...
Individual primitives have limited meaning.

Meaning emerges when they are assembled.
...
Primitives should encourage connection.
...
Geometry should move as it is constructed.
...
OpenEdu does not build experiences from pages.

It builds them from carefully connected pieces.

Geometry is the visual expression of that philosophy.
